...
//    update-end-Author:zhangguoming  Date:20140921 for：TASK #458 列表hidden=false，才是隐藏好像有点问题
	...
	protected String dictCondition;//增加查询条件属性
	protected boolean selectHidden=true;//列选择是否隐藏
	public boolean isSelectHidden() {
		return selectHidden;
	}

	public void setSelectHidden(boolean selectHidden) {
	...
	public int doEndTag() throws JspTagException {
		...
		parent.setColumn(title,field,width,rowspan,colspan,align,sortable,checkbox,formatter,formatterjs,hidden,selectHidden,replace,treefield,image,imageSize,query,url,funname,arg,queryMode, dictionary,popup,frozenColumn,extend,style,downloadName,autocomplete,extendParams,editor,dictCondition);
		return EVAL_PAGE;
	}
