...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="listenerList" actionUrl="processController.do?listenerGrid" idField="id">
			...
			<t:dgConfOpt exp="listenerstate#eq#0" url="processController.do?setListeren&id={id}&status=1" message="is.enable" title="common.enable" />
			<t:dgConfOpt exp="listenerstate#eq#1" url="processController.do?setListeren&id={id}&status=0" message="is.disable" title="operationType.disabled" />
			<t:dgDelOpt exp="listenerstate#eq#0" url="processController.do?delListeren&id={id}" title="common.delete"></t:dgDelOpt>
