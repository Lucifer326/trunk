...
draw2d.ButtonDelete = function(_20e8) {
	this.imagePath = '/js/designer/draw2d/';
	draw2d.Button.call(this, _20e8, 16, 16);
};
...
draw2d.ButtonDelete.prototype.execute = function() {
	this.palette.workflow.getCommandStack().execute(
			new draw2d.CommandDelete(this.palette.workflow
					.getCurrentSelection()));
