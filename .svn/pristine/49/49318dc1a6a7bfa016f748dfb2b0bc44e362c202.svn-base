...
import org.jeecgframework.tag.core.hplus.DatePickerTag;
...
@Scope("prototype")
@Controller
@RequestMapping("/datePickerController")
public class DatePickerController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "datePickerSourceCode")
	@ResponseBody
	public AjaxJson datePickerSourceCode(DatePickerTag datePickerTag, HttpServletRequest request){
		AjaxJson j = new AjaxJson();
		
		//调用标签类的方法 获取源码Code
		String sourceCode = datePickerTag.end().toString();
	...
	@ResponseBody
	public AjaxJson save(DatePickerTag datePickerTag, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		...
		//设置属性
		String objectToJson = JSON.toJSONString(datePickerTag);
