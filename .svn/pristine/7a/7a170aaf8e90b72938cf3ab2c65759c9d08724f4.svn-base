                                    ...
                                    <li>
                                        ...
                                        <div class="fl">
                                            <input type="text" class="form-control" id="repositoryName"
                                                   name="repositoryName" value="${vo.repositoryName}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）\\ _+——|{}【】‘；：”“'。，、？]/g,'');">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                    ...
                    <div class="example-wrap">
                        <div class="example">
                            <div class="btn-fl">
                                ...
                                <button type="button" class="btn btn-outline btn-warning" id="Edit">修改
                                </button>
                            ...
                            <table id="exampleTableEvents" data-mobile-responsive="true">
                                ...
                                <tr>
                                    ...
                                    <th data-field="scale" data-sort-stable="true" data-visible="false">建设规模</th>
                                    ...
                                    <th data-field="money" data-sort-stable="true" data-visible="false">投资情况</th>
