...
public class ResourceUtil {
	 ...
	 * 存放登陆用户当前登陆的归属部门
	 */
	public static final String LOCAL_CLINET_USER_DEPART = "LOCAL_CLINET_USER_DEPART";

	/**
	 * 存放登陆用户当前登陆的归属部门的区划id
	 */
	public static final String LOCAL_CLINET_USER_DEPART_REGIONID = "LOCAL_CLINET_USER_DEPART_REGIONID";
	
	/**
	 * 存放登陆用户归属部门列表
	 */
	public static final String LOCAL_CLINET_USER_DEPART_LIST = "LOCAL_CLINET_USER_DEPART_LIST";
