        ...
        <div class="row">
            <form id="myForm" role="form" class="form-horizontal m-t">
                ...
                <div class="form-group draggable">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="product" class="form-control" id="product" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*=|{}\[\]?~！@#￥……&*（）——|{}【】？ ]/g,'');">
                    </div>
                </div>
                <div class="form-group draggable">
                ...
                <div class="form-group draggable">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="address" class="form-control" id="address" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？ ]/g,'');">
                    </div>
                </div>
