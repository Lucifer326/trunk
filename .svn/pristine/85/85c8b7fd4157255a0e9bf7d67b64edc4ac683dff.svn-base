...
<body class="gray-bg">
                            ...
                            <div class="form-group">
                                <ul class="ulist">
                                    <li>
                                        ...
                                        <div class="fl">
                                            <input type="text" class="form-control" id="categoryNumber" name="categoryNumber" value="${vo.categoryNumber}"
                                    ...
                                    <li>
                                        ...
                                        <div class="fl">
                                            <input type="text" class="form-control"  id="categoryName" name="categoryName" value="${vo.categoryName}"
                                                   onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）_+——|{}【】‘；：”“'。，、？《》 ]/g,'');">
                                        </div>
                                        <div class="clear"></div>
                                    </li>
                                    ...
                                    <table id="exampleTableEvents" data-mobile-responsive="true">
                                        ...
                                        <tbody>
                                            <c:forEach items="${categoryList}" var="category">
                                                ...
                                                <tr>
                                                    <td><input type="checkbox"  id="${category.categoryNumber}" value="${category.categoryNumber}"/></td>
    ...
    <script type="text/javascript">
        $('#Button1').on('click',function(){
            window.location.href="${pageContext.request.contextPath}/MaterialManagement.do?searchRepSubstanceCategory&categoryNumber="+$("#categoryNumber").val()+"&categoryName="+$("#categoryName").val()+"";
        });
