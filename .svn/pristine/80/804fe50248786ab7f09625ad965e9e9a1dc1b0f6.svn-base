                ...
                <div class="row">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="outhousePerson" id="outhousePerson" value="${outPut.OUTHOUSE_PERSON}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':; '\\,\[\].<>/?~！@#￥……&*（）_+——|{}【】‘；：”“'。，、？]/g,'');" class="form-control"/>
                            </div>
                        ...
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="receiver" id="receiver" class="form-control" value="${outPut.RECEIVER}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':; '\\,\[\].<>/?~！@#￥……&*（）_+——|{}【】‘；：”“'。，、？]/g,'');"/>
                            </div>
                        ...
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="remark" id="remark" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':; '\\,\[\].<>/?~！@#￥……&*（）_+——|{}【】‘；：”“'。，、？]/g,'');" rows="3">${outPut.REMARK}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody id="tab">
                            ...
                            <tr>
                                ...
                                <td><%--物资品名--%>
                                    ...
                                    <input type="text" id="Text1" name="subName" readonly="readonly" class="form-control fl text"  value="${detail.SUB_NAME}" />
                                </td>
                                <td><%--调拨数量--%>
                                    <input type="text" id="Text2" name="allotAmount" readonly="readonly" class="form-control materials_num" value="${detail.ALLOT_AMOUNT}" />
                                </td>
                                <td><%--入库单号--%>
                                    <div id='Div3'>
                                ...
                                <td><%--库存--%>
                                    <input type="text" name="amount" id="Text5" readonly class="form-control amount" value="${detail.amount}" />
                                </td>
                                <td>
                                    <input type="number" name="outhouseAmount" id="outhouseAmount" class="form-control outhouseAmount" value="${detail.OUTHOUSE_AMOUNT}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}'e:; '\\,\[\].<>/?~！@#￥……&*（）_+——|{}【】‘；：”“'。，、？]/g,'');" />
                                </td>
                            </tr>
                            </c:forEach>
                        </tbody>
    ...
    <script>
        ...
        $('#Look').on('click', function () {
            ...
            parent.layer.open({
                ...
                shadeClose: true, //点击遮罩关闭层
                area: ['800px', '500px'],
                content: '${pageContext.request.contextPath}/MaterialsOutPut.do?MaterialsLook&uuid='+id,
                btn: ['关闭']
            });
        });
