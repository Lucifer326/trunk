...
//						+ "<input type=\"hidden\" id=\"btn_sub\" class=\"btn_sub\" />#{jform_hidden_field}<table";
				sb.append("<form action=\"cgFormBuildController.do?saveOrUpdate\" id=\"formobj\" name=\"formobj\" method=\"post\">");
				sb.append("<input type=\"hidden\" name=\"tableName\" value=\"${tableName?if_exists?html}\" />");
				sb.append("<input type=\"hidden\" name=\"id\" value=\"${id?if_exists?html}\" />");
				sb.append("<input type=\"hidden\" id=\"btn_sub\" class=\"btn_sub\" />#{jform_hidden_field}<table");
