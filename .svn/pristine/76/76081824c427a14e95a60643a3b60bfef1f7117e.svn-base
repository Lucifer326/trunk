...
//            update-begin--Author:zhangguoming  Date:20140521 for：云桌面图标拖拽、用户自定义桌面
			if (oConvertUtils.isIn("jquery-webos", types)) {
				...
				//sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus-blue/js/jquery.min.js\"></script>");
...
//	            update-end--Author:longjb1   Date:20150515 for：增加jquery cookie缓存和localstorage插件
			...
			if (oConvertUtils.isIn("jquery-hp", types)) {
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/jquery.min.js\"></script>\n");
//	            update-begin--Author:longjb1   Date:20150515 for：增加jquery cookie缓存和localstorage插件
				sb.append("<script src=\"plug-in/jquery/jquery-migrate-1.4.1.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery.cookie.js\" ></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/storage/jquery.storageapi.min.js\" ></script>\n");
				sb.append("<!--[if lte IE 8]>");
				sb.append("<script src=\"plug-in/ace/js/html5shiv.js\"></script>\n");
				sb.append("<script src=\"plug-in/ace/js/respond.js\"></script>\n");
				sb.append("<![endif]-->");
//	            update-end--Author:longjb1   Date:20150515 for：增加jquery cookie缓存和localstorage插件
			}
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery-migrate.min.js\"></script>");
				...
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/font-awesome.min.css\">");
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/bootstrap.min.css\">");				
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/animate.css\">");
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/style.css\">");
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/plugins/bootstrap-table/bootstrap-table.css\">");	
				sb.append("<link rel=\"stylesheet\" type=\"text/css\" href=\"plug-in/hplus/css/plugins/sweetalert/sweetalert.css\">");				
				
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/bootstrap.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/metisMenu/jquery.metisMenu.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/slimscroll/jquery.slimscroll.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/bootstrap-table-mobile.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js\"></script>");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/sweetalert/sweetalert.min.js\"></script>");
				
				
				
			}
			if(oConvertUtils.isIn("hplus", types)){
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery/jquery-migrate.min.js\"></script>");
				...
				//sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/bootstrap-table/bootstrap-table.min.js\"></script>\n");
				
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/bootstrap-table.min.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/bootstrap-table-mobile.min.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/demo/bootstrap-table-demo.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/layer/laydate/laydate.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/layer/layer.min.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/plugins/sweetalert/sweetalert.min.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/dataformat.js\"></script>\n");
				sb.append("<script type=\"text/javascript\" src=\"plug-in/hplus/js/content.js\"></script>\n");
				//sb.append("<script type=\"text/javascript\" src=\"plug-in/tools/syUtil.js\"></script>");				
			}
...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
				...
				sb.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/tools/curtools_{0}.js\"></script>", "{0}", lang));
			...
			if (oConvertUtils.isIn("hplisttools", types)) {
//				update-start--Author:longjb  Date:20150317 for：修改增加common css 重新定义了ace样式下的inputtxt 
//				sb.append("<link rel=\"stylesheet\" href=\"plug-in/tools/css/"+("metro".equals(cssTheme)?"metro/":"")+"common.css\" type=\"text/css\"></link>");
				sb.append(SysThemesUtil.getCommonTheme(sysThemesEnum));
//				update-end--Author:longjb  Date:20150317 for：修改增加common css 重新定义了ace样式下的inputtxt 
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
				sb.append(SysThemesUtil.getLhgdialogTheme(sysThemesEnum));
				sb.append(SysThemesUtil.getBootstrapTabTheme(sysThemesEnum));
				sb.append(StringUtil.replace("<script type=\"text/javascript\" src=\"plug-in/tools/layertools_{0}.js\"></script>\n", "{0}", lang));
			...
			if (oConvertUtils.isIn("jeasyuiextensions", types)) {
				...
				sb.append("<link href=\"plug-in/hplus/css/font-awesome.min.css\" rel=\"stylesheet\" type=\"text/css\" />");
