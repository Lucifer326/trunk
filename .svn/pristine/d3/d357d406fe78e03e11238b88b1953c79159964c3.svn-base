...
public class SysThemesUtil {
	...
	public static SysThemesEnum getSysTheme(HttpServletRequest request){
		...
		try {
			...
			for (Cookie cookie : cookies) {
				...
				if (cookie.getName().equalsIgnoreCase("JEECGINDEXSTYLE" + "_" + request.getContextPath())) {
	...
	public static String getEasyUiIconTheme(SysThemesEnum sysThemesEnum){
		...
		}if("salvation".equals(sysThemesEnum.getThemes())){
			sb.append("<link id=\"easyuiTheme\" rel=\"stylesheet\" href=\"plug-in/easyui/themes/salvation/icon.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/easyui/themes/salvation/societySalvation/css/comm.css\" type=\"text/css\"></link>");
			sb.append("<link rel=\"stylesheet\" href=\"plug-in/easyui/themes/salvation/societySalvation/css/font-awesome.css\" type=\"text/css\"></link>");
		}else {
