...
<div class="easyui-layout" style="width: 1000px; height: 600px;">
	...
	<div data-options="region:'center'">
		<t:datagrid name="userList1" title="common.user.select"
			actionUrl="userAgentController.do?agentGrid" fit="true"
			...
			<t:dgCol title="common.department" sortable="false"
				field="userOrgList.tsDepart.departname" query="false" width="300"></t:dgCol>
			...
			<t:dgCol title="common.status" sortable="true" field="status"
				replace="common.active_1,common.inactive_0,super.admin_-1"
				width="300"></t:dgCol>
		</t:datagrid>
	</div>
</div>
