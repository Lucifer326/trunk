...
public class LogController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "errorLog")
	public ModelAndView errorLog() {
		return new ModelAndView("system/log/errorLogList");
	}
	...
	public void datagrid(String moduleName,String operatetype, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		if(StringUtil.isNotEmpty(moduleName)){
			cq.eq("moduleName", moduleName);
		}
		if(StringUtil.isNotEmpty(operatetype)){
			cq.eq("operatetype", Short.parseShort(operatetype));
		}
