                                ...
                                <div class="form-group">
                                    <ul class="ulist">
                                        <li>
                                            ...
                                            <div class="fl">
                                                <input type="text" class="form-control" id="subNumber" name="subNumber" value="${subNumber}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？ ]/g,'');"/>
                                            </div>
                                            <div class="clear"></div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="fl">
                                                <input type="text" class="form-control" id="subName" name="subName" value="${subName}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？ ]/g,'');"/>
                                            </div>
                                            <div class="clear"></div>
                                        </li>
                                        <li>
                                    ...
                                    <table id="exampleTableEvents" data-mobile-responsive="true">
                                        ...
                                        <c:forEach items="${substanceMessages}" var="messages" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${messages.UNIT}</td>
                                                <td class="this_td" style="display: none">${messages.supplier}</td>
                                                <td class="this_td" style="display: none">${messages.price}</td>
                                                <td class="this_td" style="display: none">${messages.uuid}</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>
