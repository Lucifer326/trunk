	  		   ...
	  		   success: function(data){
	  			...
	  			$.each(arrayFileObj,function(n,file){
	  				...
	  				var td_title = $("<td>" + file.title + "</td>")
	  		  		...
	  		  		var td_del = $("<td><a href=\"javascript:void(0)\" class=\"jeecgDetail\" onclick=\"delFile('cgUploadController.do?delFile&id=" + file.fileKey + "',this)\">删除</a></td>");
