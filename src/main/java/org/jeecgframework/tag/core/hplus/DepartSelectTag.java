...
public class DepartSelectTag extends TagSupport {
	...
	public StringBuffer end() {
		...
		sb.append("\n</span>");
		sb.append("\n<div class=\"fl\">");
		sb.append("\n<input readonly=\"true\" type=\"text\" id=\"" + selectedNamesInputId + "\" name=\"" + selectedNamesInputId + "\" class=\"form-control fl\" style=\"width: 70%\" onclick=\"openDepartmentSelect()\" ");
		...
		sb.append("/>");
		sb.append("	<button class=\"btn btn-primary btnh\" id=\"departSearch\" type=\"button\" onclick=\"openDepartmentSelect()\">");
