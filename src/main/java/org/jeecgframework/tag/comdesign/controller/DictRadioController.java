...
@Scope("prototype")
@Controller
@RequestMapping("/dictRadioController")
public class DictRadioController {
	 ...
	 * @return
	 */
	@RequestMapping(params = "dictRadioSourceCode")
	@ResponseBody
	public AjaxJson dictRadioSourceCode(DictRadioTag dictRadioTag, HttpServletRequest request){
		AjaxJson j = new AjaxJson();
		
		//调用标签类的方法 获取源码Code
		String sourceCode = dictRadioTag.end().toString();
	...
	@ResponseBody
	public AjaxJson save(DictRadioTag dictRadioTag, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		...
		//设置属性
		String objectToJson = JSON.toJSONString(dictRadioTag);
