...
import org.jeecgframework.tag.core.hplus.DictCheckboxTag;
...
@Scope("prototype")
@Controller
@RequestMapping("/dictCheckboxController")
public class DictCheckboxController {
	 ...
	 * @param dictCheckboxTag
	 * @param request
	 * @return
	 */
	@RequestMapping(params = "dictCheckboxSourceCode")
	@ResponseBody
	public AjaxJson dictCheckboxSourceCode(DictCheckboxTag dictCheckboxTag, HttpServletRequest request){
		AjaxJson j = new AjaxJson();
		
		//调用标签类的方法 获取源码Code
		String sourceCode = dictCheckboxTag.end().toString();
	...
	@ResponseBody
	public AjaxJson save(DictCheckboxTag dictCheckboxTag, HttpServletRequest request) {
		AjaxJson j = new AjaxJson();
		...
		//设置属性
		String objectToJson = JSON.toJSONString(dictCheckboxTag);
