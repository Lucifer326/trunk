...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="jformGraphreportHeadList" checkbox="true" fitColumns="false" title="图表配置" actionUrl="jformGraphreportHeadController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="jformGraphreportHeadController.do?goAdd" funname="add" width="1400" height="700"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="jformGraphreportHeadController.do?goUpdate" funname="update" width="1400" height="700"></t:dgToolBar>
