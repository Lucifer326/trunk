		...
		<tr>
			...
			<td class="value">
			  <input class="inputxt" id="tableName" name="tableName" value="${cgFormHeadPage.tableName}"
				prefixName="" <c:if test="${cgFormHeadTable == true}">readonly="readonly"</c:if> datatype="ff" validType="cgform_head,table_Name,id" nullmsg=<t:mutiLang langKey="please.input.table.name"/>> 
				<span class="Validform_checktip"></span>
			</td>
			<td align="right"><label class="Validform_label"> <t:mutiLang langKey="table.description"/>: </label></td>
			<td class="value"><input class="inputxt" id="content" name="content" value="${cgFormHeadPage.content}" datatype="s2-100" nullmsg="请填写表描述"/> <span class="Validform_checktip"></span></td>
		</tr>
		<tr>
