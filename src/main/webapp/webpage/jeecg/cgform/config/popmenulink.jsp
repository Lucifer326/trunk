...
<body>
    <div>
		在线测试地址路径：    
        <input id='menuLink'  type='text' style="width:380px;" disabled="disabled"/></br>
        <c:if test="${not empty generateUrl}">
                    代码生成地址路径：
        <input id='generateLink' type='text' style="width:380px;" value="${generateUrl}" disabled="disabled"/>
        </c:if>            
    </div>
