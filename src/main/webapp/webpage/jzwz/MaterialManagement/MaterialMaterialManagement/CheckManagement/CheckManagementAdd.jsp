...
<body class="add-dis">
       ...
       <div class="form-group draggable">
        ...
        <div class="form-group draggable">
            <label class="col-sm-2 control-label">检测完成日期：</label>
             <div class="col-sm-4">
                 <input id="hello4" class="laydate-icon form-control layer-date">
             </div>
    ...
    <script>
     ...
     laydate({  
         elem: '#hello3', //目标元素。由于laydate.js封装了一个轻量级的选择器引擎，因此elem还允许你传入class、tag但必须按照这种方式 '#id .class'
         event: 'focus' //响应事件。如果没有传入event，则按照默认的click
     });
     laydate({
         elem: '#hello4', //目标元素。由于laydate.js封装了一个轻量级的选择器引擎，因此elem还允许你传入class、tag但必须按照这种方式 '#id .class'
         event: 'focus' //响应事件。如果没有传入event，则按照默认的click
     });
