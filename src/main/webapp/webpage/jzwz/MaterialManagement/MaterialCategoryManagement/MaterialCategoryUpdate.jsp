...
<body class="add-dis">
    <div class="wrapper wrapper-content animated">
        <div class="row">
            <form role="form" class="form-horizontal m-t" id="materialCategoryModify">
                ...
                <div class="form-group draggable">
                    ...
                    <div class="col-sm-4">
                        <input type="text" readonly="readonly" name="categoryNumber" id="categoryNumber" class="form-control" value="${category.categoryNumber}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）_——|{}【】‘；：”“'。，、？]/g,'');">
                    </div>
                    <label class="col-sm-2 control-label"><span class="start">*</span>物资类别名称：</label>
                    <div class="col-sm-4">
                        <input type="text" name="categoryName" id="categoryName" class="form-control"  value="${category.categoryName}" onkeyup="this.value=this.value.replace(/[`~!@·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（） \\_——|{}【】‘；：”“'。，、？]/g,'');">
                    </div>
                </div>
                <div class="form-group draggable">
                    <label class="col-sm-2 control-label">备注：</label>      
                    <div class="col-sm-10">
                        <textarea class="form-control" name="remark" id="remark" rows="3">${category.remark}</textarea>
                    </div>               
                </div>
            </form>
        </div>
