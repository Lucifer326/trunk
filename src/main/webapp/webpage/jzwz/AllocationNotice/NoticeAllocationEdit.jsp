                ...
                <div class="row">
                    <div class="form-horizontal">
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-4">
                                <div id="Div1">
                                    <input type="text" id="txt" name="reloefProject"  class="form-control fl" style="width: 70%" value="${rep.reloefProject}" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-group draggable">
                            ...
                            <div class="col-sm-4">
                                <input type="text" id="callinDepartment" name="callinDepartment" value="${rep.callinDepartment}" class="form-control" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');"/>
                            </div>
                            <label class="col-sm-2 control-label">调拨日期：</label>
                            <div class="col-sm-4">
                                <input id="hello"  name="allotDate" value="<fmt:formatDate value="${rep.allotDate}" pattern="yyyy-MM-dd"></fmt:formatDate>" class="laydate-icon form-control layer-date" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');"/>
                            </div>
                        </div>
                        <div class="form-group draggable">
                            <label class="col-sm-2 control-label">调出部门：</label>
                            <div class="col-sm-4">
                                <input type="text" id="diaochubum" name="calloutDepartment" class="form-control" value="${rep.calloutDepartment}" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');" />
                            </div>
                            <label class="col-sm-2 control-label">物资用途：</label>
                            <div class="col-sm-4">
                                <div id="file-pretty">
                                    <input type="text" id="wuziuse" name="storageUse" class="form-control" value="${rep.storageUse}" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group draggable">
                        ...
                        <c:forEach items="${map}" var="de">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div id="Div3">
                                        <input type="text" id="mess2" name="mess" readonly="readonly" class="form-control fl text" style="width:100%;text-align:center;" value="${de.sub_name}" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');"/>
                                ...
                                <td>
                                    <input type="text" name="allotAmount" class="form-control" value="${de.allot_amount}" onchange="shuzi(this)" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
                                           onafterpaste="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'0')}else{this.value=this.value.replace(/\D/g,'')}" onkeyup="this.value=this.value.replace(/[`~!@ ·%#$^&*()=|{}':;',\[\].<>/?~！@#￥……&*（）——|{}【】‘；：”“'。，、？]/g,'');"/>
