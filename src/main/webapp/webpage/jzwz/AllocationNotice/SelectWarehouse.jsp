									...
									<li>
										...
										<div class="fl">
											<select class="form-control w-196" id="repositoryCategory"
												...
												<option value="">-请选择-</option>approval_status
												<c:forEach items="${approval_status}" var="warehouseType">
													<option value="${warehouseType.typecode}"
													        <c:if test="${vo.repositoryCategory ==warehouseType.typecode}">selected</c:if>>${warehouseType.typename}</option>
												</c:forEach>
											</select>
										</div>
										<div class="clear"></div>
						...
						<div class="example">
							...
							<table id="exampleTableEvents" data-mobile-responsive="true">
								...
								<tr>
									...
									<th data-field="uuid" data-sort-stable="true" class="this_td">库房</th>
									...
									<%--<th data-field="uuid" data-sort-stable="true"></th>--%>
								</tr>
								</thead>
								<tbody>
		...
		function CheckSelect1() {
			...
			$("#exampleTableEvents").find('tr').each(function () {
				if ($(this).hasClass('selected')) {
					selectedCount++;
					if (selectedCount == 1) {
						str = $(this).children("td").eq(2).html() + "," + $(this).children("td").eq(3).html();
					}
				}
			});
			if (selectedCount > 1) {
