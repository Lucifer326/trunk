                                ...
                                <div class="form-group">
                                    <ul class="ulist">
                                        <li>
                                            ...
                                            <div class="fl">
                                                <input type="text" class="form-control" id="repositoryName" name="repositoryName" value="${vo.repositoryName}" onkeydown="if(event.keyCode==32||event.keyCode==13){return false;}">
                                            </div>
                                            <div class="clear"></div>
                                        </li>
