                        ...
                        <div class="form-group">
                            <ul class="ulist">
                                <li>
                                    ...
                                    <div class="fl">
                                        <input type="text" id="categoryNumber" value="${vo.categoryNumber}"
                                               class="form-control">
                                    </div>
                                    <div class="clear"></div>
                                </li>
                                <li>
                                    ...
                                    <div class="fl">
                                        <input type="text" id="categoryName" value="${vo.categoryName}"
                                               class="form-control">
                                    </div>
                            ...
                            <div class="example">
                                ...
                                <table id="exampleTableEvents" data-mobile-responsive="true">
                                    ...
                                    <c:forEach items="${list}" var="list" varStatus="i">
                                        <tr>
                                            <td><input type="checkbox" value="${list.uuid}"></td>
