		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
			<tr>
				...
				<td class="value" nowrap>
					...
					<t:choose hiddenName="id" hiddenid="id" url="activitiController.do?goEntrust&taskId=${taskId}" name="entrusterList" icon="icon-search" left="50%" width="550px" height="550px" title="用户列表" textname="last" isclear="true"></t:choose>
