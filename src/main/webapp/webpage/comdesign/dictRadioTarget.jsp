						...
						<t:formvalid layout="div" dialog="false" formid="formobj" beforeSubmit="onBeforeSub" tiptype="1">
							...
							<table cellpadding="5">
								<tr>
									...
									<td><input class="easyui-textbox" id="field" type="text" name="field" onblur="setProperty(this);" datatype="*"/></td>
									<td>显示格式:</td>
									<td>
								...
								<tr>
									...
									<td class="code">
										...
										<h:comboTree url="controlGeneratorService.getTSTypegroups" width="200" onSelect="typegroupcodeSetPor" name="typeGroupCode" id="typeGroupCode"></h:comboTree>
									</td>
								</tr>
