...
<div region="center" style="padding:0px;border:0px">
    <t:datagrid name="iconList" title="icon.list" actionUrl="iconController.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group" >
        ...
        <t:dgCol title="common.icon.type" field="iconType" replace="system.icon_1,menu.icon_2,desktop.icon_3" query="true"></t:dgCol>
