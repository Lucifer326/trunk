...
<t:datagrid title="log.manage" name="logList" actionUrl="logController.do?datagrid&operatetype=3" idField="id" sortName="operatetime" sortOrder="desc" pageSize="1000" extendParams="view:scrollview,">
	...
	<t:dgCol title="模块名称" field="moduleName" width="200"></t:dgCol>
...
<div id="logListtb" style="padding: 3px; height: 25px">
    ...
    <div name="searchColums" style="float: right; padding-right: 15px;">
    	...
    	<span>
    		<span style="vertical-align:middle;display:-moz-inline-box;display:inline-block;width: 80px;text-align:right;" title="模块名称 ">模块名称: </span>
    		<input type="text" id="moduleName" style="width: 100px; height: 24px;">
    	</span>
