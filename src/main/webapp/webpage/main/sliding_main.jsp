		...
		<div class="taskbar_start_menu_container" id="startMenuContainer" _olddisplay="block" style="display: none;">  
			...
			<ul class="taskbar_start_menu">
                ...
                <c:if test="${fn:length(sessionScope.LOCAL_CLINET_USER_DEPART_LIST) > 1}">
                	<li cmd="favorite">
						<div style="background: url(plug-in/login/images/exit.png) no-repeat left center;padding-left:30px;"
	                         onclick="add('<t:mutiLang langKey="common.change.depart"/>','userController.do?changeDepart',null,560,200)"><t:mutiLang langKey="common.change.depart"/> </div>
					</li>
                </c:if>
				<li cmd="favorite">
					<div style="background: url(plug-in/login/images/exit.png) no-repeat left center;padding-left:30px;"
				...
				<li cmd="favorite">
					<div style="background: url(plug-in/login/images/exit.png) no-repeat left center;padding-left:30px;"
                         onclick="updateVersion()">版本更新 </div>
				</li>
				<li cmd="logout">
