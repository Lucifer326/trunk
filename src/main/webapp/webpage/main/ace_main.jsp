...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="<t:mutiLang langKey="platform. title"/>" />
		<meta name="description" content="<t:mutiLang langKey="platform. title"/>" />
		...
		<div class="navbar navbar-default" id="navbar">
			...
			<div class="navbar-container" id="navbar-container">
				<div class="navbar-header pull-left">
					...
					<t:mutiLang langKey="platform.common.title"/>
						<!-- <small>
							<i class="icon-leaf"></i>
							JEECG 微云快速开发平台
						</small> -->
