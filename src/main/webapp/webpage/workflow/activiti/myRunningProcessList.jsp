...
<div class="easyui-layout" fit="true">
	<div region="center" style="padding:0px;border:0px">
		<t:datagrid name="myRunningProcessList" title="processes.i.created" autoLoadData="true" actionUrl="processInstanceController.do?myRunningProcessListDataGrid" sortName="userName" fitColumns="true" idField="id" fit="true" queryMode="group">
			...
			<t:dgFunOpt exp="endtime#eq#" funname="invalidProcess(processInstanceId,isSuspended)" title="invalid.process"></t:dgFunOpt>
			<t:dgFunOpt exp="endtime#eq#" funname="callBackProcess(processInstanceId,isSuspended)" title="return.process"></t:dgFunOpt>
			<%-- <t:dgFunOpt funname="viewHistory(processInstanceId)" title="common.history"></t:dgFunOpt>--%>
			<t:dgFunOpt funname="goProcessHisTab(processInstanceId)" title="common.history"></t:dgFunOpt>
		</t:datagrid>
	</div>
</div>
