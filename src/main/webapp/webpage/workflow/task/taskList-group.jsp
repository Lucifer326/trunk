...
<t:dgCol title="process.instance" field="Process_task_processInstanceId" width="100"></t:dgCol>
 ...
 <t:dgConfOpt exp="Process_task_assignee#empty#true" url="activitiController.do?claim&taskId={Process_task_id}" message="common.claim.sure" title="common.claim"></t:dgConfOpt>
 <t:dgFunOpt exp="Process_task_assignee#empty#false" funname="openhandle(Process_task_id,Process_task_name)" title="process.handle"></t:dgFunOpt>
</t:datagrid>
