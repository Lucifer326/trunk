...
<%--   <t:base type="jquery,tools,easyui,DatePicker"></t:base> --%>
 ...
 <body>
 	<fieldset style="border: 1px solid #E6E6E6;">
 		<legend>表单信息</legend>
   		<iframe id="taskformiframe" src="taskController.do?goProcessHisForm&load=detail&processInstanceId=${processInstanceId }" scrolling="no" frameborder="0" width="100%" onload="iframeresize('taskformiframe');"></iframe>
   </fieldset>
...
<c:if test="${bpmLogListCount > 0}">
    	<div  class="ui-widget-content ui-corner-all" style="padding: 10px; margin: 10px;">
		    	 ...
		    	 <c:if test="${taskName != null }">
		    	 	...
		    	 	<div class="progress progress3">
			    	 	<div class="detial">
					       ...
					       [<span><t:mutiLang langKey="common.task.operator"/>：${task.assignee }]</span>
			          	</div>
		          	</div>
		    	 </c:if>
    	 ...
    	 <c:if test="${bpmLogNewListCount>0}">
...
<!--							<a href="javascript:void(0)" class="jeecgDetail" onclick="del('tFinanceController.do?delFile&id=${bpmFile.id}',this)">删除</a>-->
		     ...
		     <br>
		     <tr height="35" name="trhide" style="display:none">
		     	<td class="value" style="padding: 0px 5px;">
		    ...
		    <tr name="trhide" style="display:none">
			  <td class="value" style="padding: 0px 5px;">
			...
			<tr> 
			  <td class="value" name="trhide" style="display:none">
