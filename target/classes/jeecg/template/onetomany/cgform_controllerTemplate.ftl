...
public class ${entityName}Controller extends BaseController {
	...
	public ModelAndView ${sub.entityName?uncap_first}List(${entityName}Entity ${entityName?uncap_first}, HttpServletRequest req) {
		...
		<#list subTab as sub>
	/**
	 * 加载明细列表,专为hplus风格服务[${sub.ftlDescription}]
	 * 
	 * @return
	 */
	@RequestMapping(params = "ac=${sub.entityName?uncap_first}ListH")
	public ModelAndView ${sub.entityName?uncap_first}ListH(${entityName}Entity ${entityName?uncap_first}, HttpServletRequest req) {
